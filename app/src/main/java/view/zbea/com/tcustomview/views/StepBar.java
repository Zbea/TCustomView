 ...
 class StepBar extends View
{
    ...
    /**未完成的步骤的颜色*/
    public static final int COLOR_BAR_UNDONE=0XFFf1f1f1;
    /**完成步骤的颜色*/
    public static final int COLOR_BAR_DONE=0XFF3fcccb;
    /**默认线条高度*/
    public static final int DEFAULT_LINE_HEIGHT = 10;
    /**默认小圆的半径*/
    public static final int DEFAULT_SMALL_CIRCLE_RADIUS=15;
    /**默认大圆的半径*/
    public static final int DEFAULT_LARGE_CIRCLE_RADIUS=30;
     /**默认距离边缘的距离*/
