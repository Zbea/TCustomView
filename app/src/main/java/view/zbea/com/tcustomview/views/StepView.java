...
//    }
    ...
    private void init(Context mContext, AttributeSet attrs, int defStyleAttr){
        View view= LayoutInflater.from(mContext).inflate(R.layout.custom_step_view,null,false);
        mStepBar=(StepBar)view.findViewById(R.id.step_bar);
        mTitleGroup=(FrameLayout)view.findViewById(R.id.step_title);
